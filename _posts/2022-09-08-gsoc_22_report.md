...
![run_beta_]( {{ 'assets/img/gsoc/run_beta.png' | relative_url }} )
{: style="width: 100%;" class="center"}
Fig. 1. run_beta environment
{:.image-caption}

![run_beta_]( {{ 'assets/img/gsoc/run_beta_bill.png' | relative_url }} )
{: style="width: 100%;" class="center"}
Fig. 2. run_beta_bill environment
{:.image-caption}


![run_beta_]( {{ 'assets/img/gsoc/run_beta_bill_walking.png' | relative_url }} )
{: style="width: 100%;" class="center"}
Fig. 3. run_beta_bill_walking environment
{:.image-caption}


![run_beta_]( {{ 'assets/img/gsoc/run_beta_infirmary.png' | relative_url }} )
{: style="width: 100%;" class="center"}
